...
<svelte:head>
  <title>Admin Login - Table Serve</title>
</svelte:head>
...
<div class="min-h-screen flex flex-col items-center justify-center bg-neutral-50 dark:bg-neutral-950 px-4">
  ...
  <div class="w-full max-w-sm">
    <div class="text-center mb-8">
      ...
      <h1 class="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Restaurant Admin</h1>
      <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">Sign in to manage your restaurant</p>
    </div>
    ...
    <div class="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 shadow-sm">
      <form onsubmit={handleLogin} class="space-y-4">
        ...
        <Input label="Email" type="email" bind:value={email} required placeholder="you@restaurant.com" autocomplete="email" />
        <Input label="Password" type="password" bind:value={password} required placeholder="Your password" autocomplete="current-password" />
    ...
    <p class="text-center text-sm text-neutral-500 dark:text-neutral-400 mt-6">
      New restaurant?
      <a href="/admin/register" class="text-brand-600 dark:text-brand-400 font-medium hover:underline">Create an account</a>
    </p>
  </div>
</div>
